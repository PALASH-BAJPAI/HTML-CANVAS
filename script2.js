...
const contacts = new(function() {
    ...
    animTL
        .staggerFromTo(slices, .7, { x: '100%', ease: 'Power1.easeInOut' }, { x: '0%', ease: 'Power1.easeInOut' }, .07, 0);
    spans.forEach((spanRow, idx) => {
        textsATL.staggerFromTo(spans[idx], 0.3, { y: '100%', ease: 'Expo.easeOut' }, { y: '0%', ease: 'Expo.easeOut' }, .03, '-=.7');
    });
    linksATL
        .staggerFromTo(cardLinks, .7, { y: '100%', ease: 'Power3.easeOut' }, { y: '0%', ease: 'Power3.easeOut' }, .1, 1.3);
...
const constorls = new(function() {
    ...
    function createCtrlAnim(ctrls, nextWrap) {
        return new TimelineMax({ paused: true })
            ...
            .fromTo(ctrls[0], .8, { y: '100%', ease: 'Power1.easeInOut' }, { y: '0%', ease: 'Power1.easeInOut' }, 0)
            .fromTo(ctrls[1], .8, { y: '-100%', ease: 'Power1.easeInOut' }, { y: '0%', ease: 'Power1.easeInOut' }, 0);
    }
...
const infoScene = new(function() {
    ...
    function createSlotAnim(fourSlots, currSlotsWrap, nextSlotsWrap) {
        return new TimelineMax({ paused: true })
            ...
            .fromTo([fourSlots[1], fourSlots[3]], .8, { x: '-100%', ease: 'Power1.easeInOut' }, { x: '0%', ease: 'Power1.easeInOut' }, 0)
            .fromTo([fourSlots[0], fourSlots[2]], .7, { x: '-100%', ease: 'Power1.easeInOut' }, { x: '0%', ease: 'Power1.easeInOut' }, '-=.7');
    }
...
slides = new(function() {
    ...
    function goToNextSlide(targetSliceNum, dir) {
        ...
        function onCompleteSlideChange() {
            ...
            onCompleteATL
                .staggerFromTo(nextSortedTagline, .55, { y: '100%', ease: 'Power1.easeInOut' }, { y: '0%', ease: 'Power1.easeInOut', clearProps: 'y' }, .05)
                .staggerFromTo(nextSlideDigits, .8, { y: '100%', ease: 'Power1.easeInOut' }, { y: '0%', ease: 'Power1.easeInOut', clearProps: 'y' }, .1, 0);
